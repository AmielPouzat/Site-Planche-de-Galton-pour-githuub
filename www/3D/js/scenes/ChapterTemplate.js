// ============================================
// CHAPTER TEMPLATES
// Le template de scène est volontairement centré sur l'ambiance et la navigation.
// Les objets pédagogiques viendront ensuite dans `learningObjects`.
// ============================================
...
const ChapterTemplates = {
    ...
    sciences: {
        ...
        subtitle: "Scène de test pour l'ambiance sciences. Retour possible par le portail.",
        theme: 'cartoon-shiny',
        spawn: { x: 0, z: 12, rotation: 0 },
        world: baseWorld,
        scene: {
